...
describe('Testing PMS', function () {
    ...
    it.only('The "PMS - Willkommen" page should load', function () { return __awaiter(_this_1, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, page.home.logIn()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, page.base.openHelpMenu()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, page.base.onlineManualButton.isDisplayed()];
                case 3:
                    onlineManualBtn = _a.sent();
                    chai_1.expect(onlineManualBtn).to.be["true"];
                    return [2 /*return*/];
            }
        });
    }); });
    it('The "PMS - Willkommen" page should load', function () { return __awaiter(_this_1, void 0, void 0, function () {
        var title;
        return __generator(this, function (_a) {
            switch (_a.label) {
