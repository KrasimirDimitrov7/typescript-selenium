        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log(imageFileName + '    ssssssssssssssssssss');
                    imageFilePath = browser.pathOfScreenshotFolder() + "\\" + imageFileName;
                    console.log(imageFilePath + '    fffffffffffffffffff');
                    _this = this;
                    return [4 /*yield*/, browser.saveScreenshot(imageFilePath)];
                case 1:
                    _a.sent();
