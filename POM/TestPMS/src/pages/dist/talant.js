...
var Talant = /** @class */ (function (_super) {
    ...
    Talant.prototype.fillInRegistration = function (text) {
    ...
    ], Talant.prototype, "openRegField");
    __decorate([
        lib_1.findBy("register-email", "id")
    ], Talant.prototype, "mailFieldRegistration");
    __decorate([
        lib_1.findBy("register-password", "id")
    ], Talant.prototype, "passFieldRegistration");
    __decorate([
        lib_1.findBy("//*[@id='formRegister']/input[3]", "xpath")
    ], Talant.prototype, "registrationBtn");
    return Talant;
}(page_1.Page));
exports.Talant = Talant;
exports["default"] = Talant;
