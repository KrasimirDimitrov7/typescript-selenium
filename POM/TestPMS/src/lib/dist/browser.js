...
var Browser = /** @class */ (function () {
    ...
    Browser.prototype.openNewTab = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.driver.switchTo().newWindow('tab')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.driver.navigate().to(url)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Browser.prototype.switchToSpecificTab = function (number) {
        return __awaiter(this, void 0, void 0, function () {
            var wins;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.driver.getAllWindowHandles()];
                    case 1:
                        wins = _a.sent();
                        return [4 /*yield*/, this.driver.switchTo().window(wins[number])];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Browser.prototype.scroll = function (upDown) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.driver.executeScript('window.scrollTo(' + '0' + ',' + upDown + ')')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Browser.prototype.pressEnter = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.driver.actions().sendKeys(selenium_webdriver_2.Key.ENTER).perform()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Browser.prototype.moveMouseAndClick = function (elem, x, y) {
        return __awaiter(this, void 0, void 0, function () {
            var actions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, actions.move({ duration: 200, origin: elem, x: x, y: y }).perform()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
